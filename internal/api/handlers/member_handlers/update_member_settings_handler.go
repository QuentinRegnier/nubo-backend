...
// @Produce      json
// @Security     ApiKeyAuth
// @Param        payload body member_models.UpdateMemberSettingsInput true "Paramètres à mettre à jour"
// @Success      200 {object} member_models.UpdateMemberSettingsOutput
...
func UpdateMemberSettingsHandler(c *gin.Context) {
	...
	var input member_models.UpdateMemberSettingsInput
	...
	output, err := member_service.UpdateMemberSettings(c.Request.Context(), userID, input)
	if err != nil {
		nubo_error.RespondWithError(c, err)
		return
	}
