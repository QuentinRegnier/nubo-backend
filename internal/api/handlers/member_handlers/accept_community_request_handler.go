...
// @Param input body member_models.AcceptCommunityRequestInput true "Identifiants de la conversation et de la cible"
// @Success 200 {object} member_models.AcceptCommunityRequestOutput
...
func AcceptCommunityRequestHandler(c *gin.Context) {
	...
	var input member_models.AcceptCommunityRequestInput
	...
	output, err := member_service.AcceptCommunityRequest(c.Request.Context(), callerID, input)
	if err != nil {
		nubo_error.RespondWithError(c, err)
		return
	}
