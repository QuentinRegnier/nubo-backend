...
// @Description Récupère la liste paginée des amis d'un utilisateur.
// @Tags relations
// @Accept json
// @Produce json
// @Param Authorization header string true "Bearer <votre_jwt>"
// @Param request body relation_models.GetFriendsInput true "Données de pagination"
// @Success 200 {object} relation_models.GetFriendsOutput
// @Router /relations/friends [post]
