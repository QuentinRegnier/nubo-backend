...
// @Param input body conversation_models.GetCommunityRequestsInput true "Paramètres de la requête"
// @Success 200 {object} conversation_models.GetCommunityRequestsOutput
...
func GetCommunityRequestsHandler(c *gin.Context) {
	...
	var input conversation_models.GetCommunityRequestsInput
	...
	output, err := conversation_service.GetCommunityRequests(c.Request.Context(), callerID, input)
	if err != nil {
		nubo_error.RespondWithError(c, err)
		return
	}
