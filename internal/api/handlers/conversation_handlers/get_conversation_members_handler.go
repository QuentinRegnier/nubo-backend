...
// @Param        data          body   conversation_models.GetConversationMembersInput true "Tableau des IDs de conversations"
// @Success      200  {array}  conversation_models.ConversationMembersList
...
func GetConversationMembersHandler(c *gin.Context) {
	...
	var input conversation_models.GetConversationMembersInput
