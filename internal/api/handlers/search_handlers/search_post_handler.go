...
// @Description Recherche de posts via des hashtags ou des préfixes d'utilisateurs avec filtres avancés.
...
// @Param payload body search_models.SearchPostInput true "Paramètres de recherche et filtres"
