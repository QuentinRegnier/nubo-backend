...
// GetLSHCandidateIDs récupère l'ensemble des post IDs présents dans les buckets
...
// RemoveLSHBucket retire un post de son bucket LSH (utile lors de la suppression d'un post).
