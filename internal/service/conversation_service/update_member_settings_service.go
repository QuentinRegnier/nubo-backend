...
func UpdateMemberSettings(ctx context.Context, callerID int64, input conversation_models.UpdateMemberSettingsInput) (conversation_models.UpdateMemberSettingsOutput, error) {
	...
	if err != nil {
		return conversation_models.UpdateMemberSettingsOutput{}, err
	}
	...
	output := conversation_models.UpdateMemberSettingsOutput{}
