...
type PostPayload struct {
	...
	TelemetryDwellSum float64   `bson:"telemetry_dwell_sum" json:"telemetry_dwell_sum" msgpack:"telemetry_dwell_sum"` // Somme des temps de vue (ms)
	TelemetryDwellSq  float64   `bson:"telemetry_dwell_sq" json:"telemetry_dwell_sq" msgpack:"telemetry_dwell_sq"`    // Somme des carrés (ms²)
	TelemetryClicks   int       `bson:"telemetry_clicks" json:"telemetry_clicks" msgpack:"telemetry_clicks"`          // Nombre de clics / deep scrolls
