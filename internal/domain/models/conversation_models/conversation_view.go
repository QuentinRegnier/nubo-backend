...
type InboxConversationView struct {
	...
	ExternalLink   models.ExternalLinks         `json:"external_link"`
	Role           int                          `json:"role"`         // 0=Membre, 1=Admin, 2=Propriétaire
	Settings       member_models.MemberSettings `json:"settings"`     // Paramètres de notification (0=Tout, 1=Silencieux, 2=Muet)
